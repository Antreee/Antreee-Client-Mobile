...
const Tabs = () => {
   return (
      ...
      >
         ...
         <Tab.Screen name="TabScreenTwo" component={TabScreenTwo} options={{
            headerShown: false,
            tabBarIcon: ({ color, size }) => (
         ...
         <Tab.Screen name="TabScreenThree" component={TabScreenThree} options={{
            headerShown: false,
            tabBarButton: tabBarButton,
         }} />
         <Tab.Screen name="TabScreenFour" component={TabScreenFour} options={{
            headerShown: false,
            tabBarIcon: ({ color, size }) => (
         ...
         <Tab.Screen name="TabScreenFive" component={TabScreenFive} options={{
            headerShown: false,
            tabBarIcon: ({ color, size }) => (
