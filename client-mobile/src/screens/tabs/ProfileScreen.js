  ...
  function portionBtn(item) {
    return (
      ...
      >
        <Image
          source={item.image}
          style={{ width: 300, height: 310, borderRadius: 10 }}
        />
        <Text
          style={{
            fontWeight: 'bold',
      ...
      <ScrollView>
        <View style={styles.headwrapper}>
          ...
          <View style={styles.barAndLove}>
            <TouchableOpacity style={styles.barIcon} onPress={showModal}>
              <Ionicons name='qr-code-sharp' size={30} color={Color.white} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.barIcon}>
              <Ionicons name='heart' size={30} color={Color.white} />
            </TouchableOpacity>
          </View>
        </View>
        <View
        ...
        >
          <Text style={{ color: Color.dark, fontWeight: 'bold', fontSize: 20 }}>
            Co-Founders
          </Text>
        </View>
        <View
