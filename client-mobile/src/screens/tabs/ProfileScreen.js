  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        >
          <Svg xmlns="http://www.w3.org/2000/svg" width={160.72} height={31.28} {...props}>
            <Path
              stroke={Color.dark}
              fill={Color.dark}
        ...
        >
          ...
          >
            Introducing NuerPay (read NewerPay) , a smart and sophisticated mobile app that elevates
            your dining experience. There is no need for waiting in line anymore, you could just
            book your favourite restaurant directly from our app. We will remind you when your
            booked time is coming. After you get there, you will be greeted by our custom QR Code on
            your table that you can scan, order, and pay directly from our app! Gone is the day
            where you wait for waiters to get the menus, take your orders and the best of all, no
            more getting wrong orders!
          </Text>
        </View>
